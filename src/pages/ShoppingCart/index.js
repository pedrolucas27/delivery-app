							    ...
							    <div className="flex shadow-md my-10">
							    		<div className="w-3/4 bg-white px-10 py-10">
								       		<div className="flex justify-between border-b pb-8">
								          		...
								          		<h2 className="font-semibold text-2xl">3 Item(s)</h2>
								        	</div>
									    ...
									    <div id="summary" className="w-1/4 px-8 py-10">
									        ...
									        <div className="flex justify-between mt-10 mb-2">
									          	<span className="font-semibold text-sm">Item(s) 3</span>
									          	<span className="font-semibold text-sm">590$</span>
									        </div>
									        <div className="py-5">
									          	<label for="promo" className="font-semibold inline-block mb-3 text-sm">Possui algum cupom ?</label>
									          	<input 
						                      		type="text"
									        ...
									        <button className="w-full text-center py-2 rounded-md bg-red-600 text-white hover:bg-red-800 focus:outline-none my-1">Aplicar</button>
									        <div className="border-t mt-5">
									          <div className="flex font-semibold justify-between py-6 text-sm">
									            <span>Total da conta</span>
									            <span>$600</span>
									          </div>
									          <button className="bg-indigo-600 w-full text-center py-2 rounded-md text-white hover:bg-indigo-800 focus:outline-none">Checkout</button>
									        </div>
									      </div>
							    		</div>
							  		</div>
